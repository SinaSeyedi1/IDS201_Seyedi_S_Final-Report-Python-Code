...
print() # Enter the df of choice to receive the desired output, for example "print(df4)".
        # To calculate the measures of central tendency, enter print(df.mean(numeric_only=True)) for mean. Enter print(df.median(numeric_only=True)) for median. Enter print(df.mode(numeric_only=True)) for mode.  
